...
- (void)addWorksheetDrawingsForAnchorType:(NSString *)anchorType {
    ...
    for (NSDictionary *wsDrDict in wsDrArray) {
        BRAWorksheetDrawing *sheetDrawing = [[BRAWorksheetDrawing alloc] initWithOpenXmlAttributes:wsDrDict];
        sheetDrawing.drawing = self;
        [worksheetDrawings addObject:sheetDrawing];
...
- (NSString *)xmlRepresentation {
    ...
    super.xmlRepresentation = [xmlHeader stringByAppendingString:[dictionaryRepresentation openXmlStringInNodeNamed:@"xdr:wsDr"]];
...
- (instancetype)copy {
    ...
    [copy.relationships setRelationships:@[]];
