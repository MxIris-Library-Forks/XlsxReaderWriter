...
const BRACellFillPatternType kBRACellFillPatternTypeNone              = @"none";
const BRACellFillPatternType kBRACellFillPatternTypeSolid             = @"solid";
const BRACellFillPatternType kBRACellFillPatternTypeDarkGray          = @"darkGray";
const BRACellFillPatternType kBRACellFillPatternTypeMediumGray        = @"mediumGray";
const BRACellFillPatternType kBRACellFillPatternTypeLightGray         = @"lightGray";
const BRACellFillPatternType kBRACellFillPatternTypeGray125           = @"gray125";
const BRACellFillPatternType kBRACellFillPatternTypeGray0625          = @"gray0625";
const BRACellFillPatternType kBRACellFillPatternTypeDarkHorizontal    = @"darkHorizontal";
const BRACellFillPatternType kBRACellFillPatternTypeDarkVertical      = @"darkVertical";
const BRACellFillPatternType kBRACellFillPatternTypeDarkDown          = @"darkDown";
const BRACellFillPatternType kBRACellFillPatternTypeDarkUp            = @"darkUp";
const BRACellFillPatternType kBRACellFillPatternTypeDarkGrid          = @"darkGrid";
const BRACellFillPatternType kBRACellFillPatternTypeDarkTrellis       = @"darkTrellis";
const BRACellFillPatternType kBRACellFillPatternTypeLightHorizontal   = @"lightHorizontal";
const BRACellFillPatternType kBRACellFillPatternTypeLightVertical     = @"lightVertical";
const BRACellFillPatternType kBRACellFillPatternTypeLightDown         = @"lightDown";
const BRACellFillPatternType kBRACellFillPatternTypeLightUp           = @"lightUp";
const BRACellFillPatternType kBRACellFillPatternTypeLightGrid         = @"lightGrid";
const BRACellFillPatternType kBRACellFillPatternTypeLightTrellis      = @"lightTrellis";
...
- (void)loadAttributes {
    ...
    if ([_patternType isEqual:kBRACellFillPatternTypeNone]) {
        ...
        _backgroundColor = [self.styles colorWithOpenXmlAttributes:[dictionaryRepresentation valueForKeyPath:@"patternFill.bgColor"]];
        _foregroundColor = [self.styles colorWithOpenXmlAttributes:[dictionaryRepresentation valueForKeyPath:@"patternFill.fgColor"]];
    }
}

- (NSDictionary *)dictionaryRepresentation {
    NSMutableDictionary *dictionaryRepresentation = [super dictionaryRepresentation].BRA_mutableDeepCopy;
        
    [dictionaryRepresentation setValue:_patternType forKeyPath:@"patternFill._patternType"];
    [dictionaryRepresentation setValue:[self.styles openXmlAttributesWithColor:_backgroundColor] forKeyPath:@"patternFill.bgColor"];
    [dictionaryRepresentation setValue:[self.styles openXmlAttributesWithColor:_foregroundColor] forKeyPath:@"patternFill.fgColor"];
