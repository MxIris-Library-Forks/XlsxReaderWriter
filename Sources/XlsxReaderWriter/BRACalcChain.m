...
- (void)loadXmlContents {
    ...
    NSDictionary *openXmlAttributes = [NSDictionary dictionaryWithOpenXmlString:super.xmlRepresentation];
...
- (NSString *)xmlRepresentation {
    ...
    super.xmlRepresentation = [xmlHeader stringByAppendingString:[dictionaryRepresentation openXmlStringInNodeNamed:@"calcChain"]];
