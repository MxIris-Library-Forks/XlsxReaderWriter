...
- (void)loadXmlContents {
   ...
   //Styles
    ...
    NSDictionary *dictionaryRepresentation = [NSDictionary dictionaryWithOpenXmlString:super.xmlRepresentation];
...
- (NSString *)xmlRepresentation {
    ...
    super.xmlRepresentation = [xmlHeader stringByAppendingString:[dictionaryRepresentation openXmlStringInNodeNamed:@"workbook"]];
