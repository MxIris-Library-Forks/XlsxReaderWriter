...
- (void)loadXmlContents {
    ...
    NSDictionary *colorsScheme = [[NSDictionary dictionaryWithOpenXmlString:super.xmlRepresentation] dictionaryValueForKeyPath:@"a:themeElements.a:clrScheme"];
...
- (NSString *)xmlRepresentation {
    ...
    //We just return self.xmlRepresentation
